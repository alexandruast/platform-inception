node {
  stage('checkout') {
    ...
    sh("curl -Ssf -X PUT -d ${checkout_info.GIT_COMMIT} http://127.0.0.1:8500/v1/kv/${APPLICATION_ENVIRONMENT}/${APPLICATION_NAME}/checkout_commit_id")
  }
  stage('build') {
    withCredentials([
      ...
      CHECKOUT_COMMIT_ID="$(curl -Ssf http://127.0.0.1:8500/v1/kv/${APPLICATION_ENVIRONMENT}/${APPLICATION_NAME}/checkout_commit_id?raw)"
